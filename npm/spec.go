...
type packageJSON struct {
	...
	Pnpm *struct {
		...
		PeerDependencyRules  json.RawMessage `json:"peerDependencyRules,omitempty"`
		PatchedDependencies  json.RawMessage `json:"patchedDependencies,omitempty"`
	} `json:"pnpm,omitempty"`
...
type ParseResult struct {
	...
	PnpmPeerDependencyRules   json.RawMessage
	PnpmPatchedDependencies   json.RawMessage
}
...
func (p *SpecParser) ParseFull(data []byte) (*ParseResult, error) {
	...
	if pkg.Pnpm != nil {
		...
		result.PnpmPeerDependencyRules = pkg.Pnpm.PeerDependencyRules
		result.PnpmPatchedDependencies = pkg.Pnpm.PatchedDependencies
	}
